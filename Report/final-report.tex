...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{areaExploredGraph.png}
    \caption{AI versus randomized algorithm movement.}
    \label{fig:four}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{killsGraph.png}
...
\begin{table}[H]
    \begin{tabular}{|p{0.3\textwidth}|p{0.6\textwidth}|}
        ...
        HW1 / HW2 & Pacman AI Homework \\ \hline
    \end{tabular}
\end{table}
\end{document}